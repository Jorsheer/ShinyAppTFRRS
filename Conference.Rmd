...
inputPanel(
  selectInput("year", "Select Year:", choices = sort(unique(final_miacs$Year)), selected = max(final_miacs$Year)),
  selectInput("event", "Select Event:", choices = sort(unique(final_miacs$Event)), selected = "60 Meters (Men)")
)
