...
*Below are different graphs that are fun to display the MIAC over the years 2017 - 2025, our goal is to show the overall "strength" of the MIAC between different events over the years, displaying athletes and their accomplishments. All data below is collected through the "Performance Lists" on TFRRS, which displays any personal records achieved during the indoor season.*
